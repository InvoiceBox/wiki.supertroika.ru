...
Используя карту, браслет или брелок «Тройка» ([носитель проездного билета](/docs/troika/)), пассажиры Москвы,
...
Особенностью «Тройки» является то, что проездной билет записывается на сам носитель ([встроенный чип NFC](/docs/nfc/)), т.е. вы
...
ввиду такой особенности, купленный билет необходимо сперва записать ([активировать](/docs/usage/activation/)) на носитель перед использованием.
...
([сервис для органиазций и ИП с оплатой по счёту](/docs/business/business/)). 
